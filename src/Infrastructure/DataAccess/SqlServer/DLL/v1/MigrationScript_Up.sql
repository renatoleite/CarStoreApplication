...
ALTER TABLE [dbo].[CAR] ADD CONSTRAINT PK_CAR_LOGIN_INC FOREIGN KEY (COD_USER_INC) REFERENCES [dbo].[LOGIN]([COD_LOGIN])
GO

ALTER TABLE [dbo].[CAR] ADD CONSTRAINT PK_CAR_LOGIN_UPD FOREIGN KEY (COD_USER_UPD) REFERENCES [dbo].[LOGIN]([COD_LOGIN])
GO
